...
namespace blackbes\yiireact\yiiReactCrud;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $viewPath;
    public $baseControllerClass = 'blackbes\yiireact\BaseController';
    ...
    {
        return 'React API CRUD Generator';
    }
    ...
    {
        return 'Generator for creating custom controllers and react views.';
    }
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            ...
            'viewPath' => 'Specify the directory for storing the view scripts for the controller. You may use path alias here, e.g.,
                ...
                to <code>@app/views/api/ControllerID</code>',
    ...
    public function generate()
    {
        ...
        foreach (scandir($templatePath) as $file) {
            ...
            if (is_file($templatePath . '/' . $file) && pathinfo($file, PATHINFO_EXTENSION) === 'php') {
                $fileEls = explode('.', $file);
                $files[] = new CodeFile("$viewPath/$fileEls[0]".'.js', $this->render("views/$file"));
            }
        }
    ...
    public function getViewPath()
    {
        if (empty($this->viewPath)) {
            return Yii::getAlias('@app/views/api/' . $this->getControllerID());
        }
